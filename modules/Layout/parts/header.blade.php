            ...
            <div class="header-left">
                ...
                <div class="bravo-menu">
                    ...
                    <ul class="main-menu menu-generated">
                        <li class=" depth-0">
                            <a target="" href="{{route('home')}}">{{__('Home')}}</a>
                        </li>
                        <li class=" depth-0">
                            <a target="" href="{{route('hotel.search')}}">{{__('Hotel')}}</a>
                        </li>
                        <li class=" depth-0">
                            <a target="" href="{{route('tour.search')}}">{{__('Tours')}}</a>
                        </li>
                        <li class=" depth-0">
                            <a target="" href="{{route('FlightBooking')}}">{{__('Flight Booking')}}</a>
                        </li>
                        <li class=" depth-0">
                            <a target="" href="{{route('page.detail').'/become-a-vendor'}}">{{__('Become a Vendor')}}</a>
                        </li>
                        @if(Auth::id())
                            <li class="depth-0">
                                <a href="{{route('user.booking_history')}}">{{__("Booking History")}}</a>
                            </li>
                        @endif
                        <li class=" depth-0">
                            <a target="" href="{{route('contact.index')}}">{{__('Contact')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
