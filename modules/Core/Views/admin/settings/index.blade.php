...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form action="{{url('admin/module/core/settings/store/'.$current_group)}}" method="post" autocomplete="off" id='setting_form'>
                    @csrf
                    ...
                    <div class="d-flex justify-content-between">
                        <span></span>
                        <button class="btn btn-primary" id='btn-test' type="submit">{{__('Save settings')}}</button>
                    </div>
                </form>
            </div>
        </div>
