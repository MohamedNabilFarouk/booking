                ...
                <form method="get" action="" class="filter-form filter-form-right d-flex justify-content-end">
                    ...
                    @if(!empty($booking_manage_others))
                        ...
                        <select name="object_model" class="form-control">
                            <option value="">{{__('Hotel')}} - {{__('Tour')}}</option>
                            <option @if(isset($_GET['object_model']) && $_GET['object_model'] == 'hotel') selected @endif value="hotel">{{__('Hotel')}}</option>
                            <option @if(isset($_GET['object_model']) && $_GET['object_model'] == 'tour') selected @endif value="tour">{{__('Tour')}}</option>
                        </select>

                        <select name="is_paid" class="form-control">
                            <option value="">{{__('Paid')}} - {{__('Unpaid')}}</option>
                            <option @if(isset($_GET['is_paid']) && $_GET['is_paid'] == '1') selected @endif value="1">{{__('Paid')}}</option>
                            <option @if(isset($_GET['is_paid']) && $_GET['is_paid'] == '0') selected @endif value="0">{{__('Unpaid')}}</option>
                        </select>
                        <button class="btn-info btn btn-icon" type="submit">{{__('Filter')}}</button>
                    </form>
                </div>
                            ...
                            @foreach($rows as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="label label-{{$row->status}}">@if($booking->is_paid == '1') Paid @else  Unpaid @endif</span>
                                    </td>
                                    <td>
