    ...
    <div class="panel-body">
        @if(is_default_lang())
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("World Price")}}</label>
                        <input type="number" min="0" name="other_price" class="form-control" value="{{$row->other_price}}" placeholder="{{__(" World price")}}">
                    </div>
                </div>
                <div class="col-lg-12">
                    <span>
