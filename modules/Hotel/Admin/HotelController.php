...
class HotelController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            'rows'     => $query->with(['author', 'rooms', 'allRoom'])->get(), //->paginate(20)
...
//dd($request->all());
        ...
        if(isset($request->auto_confirmed)){
            $row->auto_confirmed = $request->input('auto_confirmed');
        }else{
            $row->auto_confirmed = 0;
        }
