                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="hotel-info">
                                    ...
                                    {{-- here  package --}}
                    {{-- <a href="{{route('hotel.vendor.room.getRoomPackage', 45)}}" class="btn btn-warning">{{__("Show Packages")}}</a> --}}
                         {{-- hya de <a :href="'/package/'+ room.id" class="btn btn-warning">{{__("Show Packages")}}</a> --}}

@{{room.end_date}}

                        {{-- <span v-html="formatMoney(room.rooms_no*room.price)"></span> For <span v-html='room.rooms_no'></span> Room /<span v-html='room.nights_no'></span> nights --}}
                                    <ul class="room-meta">
                            ...
                            <div class="col-md-3" v-if="room.number">
                                <div class="col-price clear">
                                    <div class="text-center">
                                        ...
                                        <span> {{__('Availability')}}: <span v-html='room.number'></span> {{__('Rooms')}}
                                       <span> Recommended:</span>   <span v-html="formatMoney(room.rooms_no*room.price)"></span> For <span v-html='room.rooms_no'></span> Room /<span v-html='room.nights_no'></span> nights
                                    ...
                                    <!-- <input   :value="room.rooms_no"  v-model="room.number_selected" type='number'> -->
                                </div>
                            </div>
                            <div class="col-md-3" v-else>
                                <div class="col-price clear">
                                    <div class="text-center">
                            <span> {{__('Availability')}}: <span v-html='room.fake_number'></span> {{__('Rooms')}} <br>
                                  <span v-html="formatMoney(room.price)"></span>
                            </span></div>
                                </div>
                            </div> <!-- end of v-else -->
