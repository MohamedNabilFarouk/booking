                    ...
                    <div class="col-md-3">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                    <label>
                                        <input @if($row->auto_confirmed=='1') checked @endif type="radio" name="auto_confirmed" value="1"> {{__("Auto Checkout")}}
                                    </label>
                                </div>
                                <div>
                                    <label>
                                        <input @if($row->auto_confirmed=='0') checked @endif type="radio" name="auto_confirmed" value="0"> {{__("Manual Checkout")}}
                                    </label>
                                </div>
