...
Route::group(['prefix'=>'user/'.config('hotel.hotel_route_prefix'),'middleware' => ['auth','verified']],function(){
    ...
    Route::group(['prefix'=>'room'],function (){
        ...
        Route::get('{room_id}/package','VendorRoomController@createRoomPackage')->name('hotel.vendor.room.createPackage');
        Route::post('storePackage','VendorRoomController@storeRoomPackage')->name('hotel.vendor.room.storePackage');
        Route::get('EditPackage/{id}','VendorRoomController@editRoomPackage')->name('hotel.vendor.room.editPackage');
        Route::put('UpdatePackage/{id}','VendorRoomController@updateRoomPackage')->name('hotel.vendor.room.updatePackage');
        Route::delete('deleteRoomPackage/{id}','VendorRoomController@deleteRoomPackage')->name('hotel.vendor.room.deletePackage');


        Route::get('Allpackages','VendorRoomController@getVendorPackages')->name('hotel.vendor.getPackages');


        Route::post('BookPackage','VendorRoomController@bookRoomPackage')->name('hotel.vendor.room.bookRoomPackage');

        Route::get('booking-Package/report','VendorRoomController@bookingPackageReport')->name('vendor.booking.packageReport');
Route::get('PackageCheckout/{id}','VendorRoomController@getPackageCheckout')->name('package.checkout');


    });
});

// out of auth for package
Route::get('package/{room_id}','VendorRoomController@getRoomPackage')->name('hotel.vendor.room.getRoomPackage');
