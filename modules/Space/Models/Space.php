...
//     $roomDates =  $this->spaceDateClass::getDatesInRanges($start_date,$end_date,$this->id);

//         $allDates = [];
//     $tmp_price = 0;
//     $tmp_night = 0;
//     $period = periodDate($start_date,$end_date,true);
//     foreach ($period as $dt){
// //        for($i = strtotime($filters['start_date']); $i < strtotime($filters['end_date']); $i+= DAY_IN_SECONDS)
// //        {
//         $allDates[$dt->format('Y-m-d')] = [
//             'spaces_no'=>$this->spaces_no,
//             'price'=>$this->price
//         ];
//         $tmp_night++;
//     }
...
//                 $allDates[$date]['spaces_no'] -= 1;
//                 if($allDates[$date]['spaces_no'] <= 0){
//                     return false;
//                 }
//             }
//         }
...
//                         $allDates[date('Y-m-d',$date)]['spaces_no'] -= 1;
//                         if($allDates[date('Y-m-d',$date)]['spaces_no'] <= 0){
//                             return false;
//                         }
//                     }
...
//     $this->tmp_number = !empty($allDates) ?  (int) min(array_column($allDates,'spaces_no')) : 0;
