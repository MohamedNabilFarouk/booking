...
// start my api
 ...
 // rooms
 Route::get('/rooms/{room_id}','RoomController@getHotelRoomsPackage');
 Route::get('/UserPackageBooking/{user_id}','RoomController@getUserPackageBooking');
Route::post('/socialLogin','SocialController@social');

// mygateways
Route::get('/activeGateway','BookingController@getActiveGateway');
Route::post('/updateBookingPayment','BookingController@updateBookingPayment');
Route::post('/UpdateUserData','BookingController@updateUserData');
Route::post('/BookPackage','BookingController@bookRoomPackage');
Route::get('/forgetpass','AuthController@reset');


//Currency
Route::get('/currency','CurrencyController@getCurrency');

Route::get('/hotel/inputSearch','CurrencyController@inputSearch');
