...
class UserController extends AdminController
{
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($row->save()) {
            ...
            $vendorRequestData = VendorRequest::where('user_id',$id)->first();
            if(isset($vendorRequestData)){
                $vendorRequestData->bank_account = $request->bank_account;
                $vendorRequestData->bank_name = $request->bank_name;
                $vendorRequestData->save();
            }
