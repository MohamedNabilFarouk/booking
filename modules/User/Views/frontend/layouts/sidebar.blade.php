...
<div class="sidebar-user">
    ...
    <div class="user-profile-plan">
        @if( !Auth::user()->hasPermissionTo("dashboard_vendor_access") )
            ...
            <a href=" {{ route("user.vendorData") }}">{{ __("Become a vendor") }}</a>
    ...
    <div class="sidebar-menu">
        <ul class="main-menu">
            ...
            {{-- <li class=""><a href="{{ route('hotel.vendor.getPackages',Auth::user()->id ) }}">
                {{__("Packages")}}</a>
               </li> --}}
               ...
               @if((Auth::user()->roles[0]->name == 'vendor'))
                    @if(($index == 1))
                     <li class=""><a href="{{ route('vendor.bookingReport') }}">
                       <i class="icon ion-ios-pie"></i>{{__("Booking Report")}}</a>
                        </li> 

                        <li class=""><a href="{{ route('vendor.booking.packageReport') }}">
                       <i class="icon ion-ios-pie"></i>{{__("Packages Booked Report")}}</a>
                        </li> 
                  @endif
                  @endif
                ...
                <li class="{{$menuItem['class']}}">
                    ...
                    @if(!empty($menuItem['children']))
                        <ul class="children">
                            ...
                            @if($index == "3")
                            <li class=""><a href="{{ route('hotel.vendor.getPackages') }}">
                                 {{__("Packages")}}</a>
                               </li>
                            @endif
