...
@section('content')
    ...
    <hr>
    <h4 class="title-bar no-border-bottom">
        {{__("Transfer Report")}}
    </h4>
    <div class="bravo-user-dashboard" style='margin-top:20px;'>
<!-- table  -->
...
<div class='row'>
        ...
        <div class='form-group col-md-3'>
            <label>To</label>
            <input type="date" name='end' class="form-control" placeholder='To'>
        </div>
        <div class='form-group col-md-3'>
           
            <button class='btn btn-info' type='submit' style='margin-top:25px;'>Search</button>
        </div>
</div>
...
<thead class="thead-dark">
          <tr>
            ...
            <th class="th-lg">{{__("Date")}}
      
            </th>
            <th class="th-sm">{{__("amount")}}
        ...
        <tbody>
           @foreach($trans as $t)
            ...
            <tr>
            <td>{{$t->withdrawal_date}} </td>
            <td>{{$t->withdrawal_amount}}</td>
