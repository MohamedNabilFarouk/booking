                ...
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th class="date">{{ __('Commercial Record')}}</th>
                            <th class="date">{{ __('Tax Card')}}</th>
                            <th class="date">{{ __('Bank Account')}}</th>
                        ...
                        @if($rows->total() > 0)
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <td><a href='{{ $row->getCommercialRecordUrl()}}' download>Download Commercial Record</a></td>
                                    <td><a href='{{ $row->getTaxCardUrl()}}' download>Download Tax Card</a></td>
