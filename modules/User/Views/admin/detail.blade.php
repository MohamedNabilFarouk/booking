                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_account" @if(old("role_id") == 1) required @endif value="{{old('bank_account',$row->vendorRequest->bank_account ??'')}}" placeholder="{{__("Bank Account")}}" class="form-control">
                                    
                                        {{-- <input type="text" name="bank_account" @if(old("role_id") == 1) required @endif value="{{old('bank_account',$row->bank_account ??'')}}" placeholder="{{__("Bank Account")}}" class="form-control"> --}}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{__("bank Name")}}</label>
                                        <input type="text" name="bank_name" @if(old("role_id") == 1) required @endif value="{{old('bank_name',$row->vendorRequest->bank_name ??'')}}" placeholder="{{__("Bank Name")}}" class="form-control">
                                    
                                        {{-- <input type="text" name="bank_name" @if(old("role_id") == 1) required @endif value="{{old('bank_name',$row->bank_name ??'')}}" placeholder="{{__("Bank Name")}}" class="form-control"> --}}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
