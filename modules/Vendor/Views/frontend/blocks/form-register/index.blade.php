        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor"  method="post" action="{{route('vendor.register')}}" enctype="multipart/form-data">
                    ...
                    <!-- <input type="file" class="form-control" name="tax_card"  >
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="term">
                            ...
                            {{ __("ReadvendorTerms")}} <a href="https://hoteelsegypt.com/page/vendor-terms-and-conditions" target='_blank'>{{__("vendorTerms")}}</a> 
